...
def obtener_resultados():
    ...
    # 1. Escanear la fuente en tiempo real
    ...
    # Mapear los resultados existentes por lotería y hora
    ...
    # Ordenar por lotería y horario cronológico
