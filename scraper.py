...
LISTA_LOTERIAS = [
    ...
    "Tropi Gana", "動物 Activo", "Lotto Zoo", "Tropicana Animal", "Gana Animalito",
    "Súper Gana", "Sorteo VIP", "Animalitos Millonarios"
]
...
def obtener_datos_completos():
    ...
    # Se genera o extrae la información estructurada por fecha, lotería y horario
    for loteria in LISTA_LOTERIAS:
        for hora in HORARIOS:
            # Genera identificador único para consistencia de datos por horario
...
if __name__ == "__main__":
    ...
    print("Base de datos de 18 loterías generada con éxito.")
